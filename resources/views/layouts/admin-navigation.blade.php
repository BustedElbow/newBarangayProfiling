    ...
    <div class="flex flex-col w-full items-center gap-12">
        ...
        <div class="w-full">
            <ul class="flex flex-col gap-3">
                ...
                <li>
                    <a class="flex pl-5 gap-3 font-inter font-bold text-base py-3 {{ Request::is('*residents*') ? 'text-barangay-main border-barangay-main border-r-4 bg-slate-300' : 'text-[#1e1e1e]'}}" href="{{ route('admin.residents') }}">
                        <img class="w-[24px] h-[24px]" src="{{ Request::is('*residents*') ? asset('images/icons/resident100-main.png') : asset('images/icons/resident100-black.png') }}" alt="">
                        Residents
                    </a>
                </li>
                <li>
                    <a class="flex pl-5 gap-3 font-inter font-bold text-base py-3 {{ Request::is('*households*') ? 'text-barangay-main border-barangay-main border-r-4 bg-slate-300' : 'text-[#1e1e1e]'}}" href="{{ route('admin.households') }}">
                        <img class="w-[24px] h-[24px]" src="{{ Request::is('*households*') ? asset('images/icons/household-main.png') : asset('images/icons/household-black.png') }}" alt="">
                        Households
                    </a>
                </li>
                <li>
