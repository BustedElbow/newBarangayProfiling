...
<body class="h-screen flex justify-center items-center ">
    <div class="flex flex-col justify-center items-center border border-black border-opacity-25 rounded p-12">
        ...
        <span class="font-inter text-[#d4af37] mb-5 ">Official</span>
